--Make sure your exploit is FULL LUA and a Level7--
...
createTextLabel(Color3.fromRGB(255, 255, 255), 1, 1, Enum.Font.SourceSansBold, "Motto", screenGui.Intro, UDim2.new(0, 88, 0, 25), UDim2.new(0, 200, 0, 33), "Powering Creativity", Color3.fromRGB(255, 255, 255), 17, false, Enum.TextXAlignment.Center, Enum.TextYAlignment.Center, 1)
